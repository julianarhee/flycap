...
base_dir = '/home/julianarhee/Videos'

found_dirs = sorted(glob.glob(os.path.join(base_dir, '%s_*' % experiment_name)), key=natsort)
len(found_dirs)
...
frames = sorted(glob.glob(os.path.join(frames_dir, '*.png')), key=natsort)
