...
chosenAviType = AviType.MJPG #UNCOMPRESSED  # change me!
NUM_IMAGES = 24000  # number of images to use in AVI file
NUM_BUFFERS = 10 #1000
...
def acquire_images(cam, nodemap):
    ...
    try:
        ...
        # Set buffer mode
        handling_mode_entry = handling_mode.GetEntryByName('OldestFirst') #('NewestOnly')
