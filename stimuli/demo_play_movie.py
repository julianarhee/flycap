...
video_name='/Users/julianarhee/Documents/ruta_lab/projects/tracking/examples/melF_melM_15mm_1chamber/traces/id1_body.mp4'
# If False, no audio tracks will be played.
INCLUDE_AUDIO_TRACK = True

# Size of the PsychoPy Window to create (in pixels).
WINDOW_SIZE = [600, 400] #[1280, 720]
